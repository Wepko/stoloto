	...
	<nav id="menu">
		<ul>
			...
			@if (Auth::check())
				...
				@endif
				<li><a href="{{ route('lk') }}">Кабинет</a></li>
				<li><a href="{{ route('logout') }}">Выйти</a></li>
			@else
				<li><a href="{{ route('login') }}">Вход</a></li>
				<li><a href="{{ route('reg') }}">Регистрация</a></li>
			@endif
			<li><a href="{{ route('valid_ticket') }}">Проверка билетов</a></li>
						...
						<div class="menu">
								...
								<nav class="menu__navigation">
									<ul class="menu__list">
										...
										<li class="menu__item"><a href="{{ route('logout') }}" class="menu__el"> <svg class="menu__icon" width="21" height="20" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
										...
										<li class="menu__item"><a href="{{ route('login') }}" class="menu__el"> <svg class="menu__icon" width="21" height="20" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
												viewBox="0 0 67 67" style="enable-background:new 0 0 67 67;" xml:space="preserve">
										<g>
											<g>
												<path d="M4.25,35h39.899L33.86,45.478c-0.781,0.78-0.781,2.142-0.001,2.923c0.391,0.391,0.902,0.634,1.415,0.634
