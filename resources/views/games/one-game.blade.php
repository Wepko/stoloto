                                ...
                                <div class="prize-pool">
                                    <div class="prize-pool__title">Призовой фонд игры</div>
                                        <div class="prize-pool__list">
                                            ...
                                            <div class="prize-pool__item">5</div>
                                    ...
                                    <div class="panel-score">
                                        <p class="panel-score__discription">Стоимость одного билета 200р</p>
                                        ...
                                        <div class="panel-score__btns">
                                            ...
                                            <a href="{{ route('tutorials-one-game')}}" class="btn-orange-revers mt-3" style="width: 100%">Как играть?</a>
                                        </div>
                                    </div>
                            </div>
                        </div>
