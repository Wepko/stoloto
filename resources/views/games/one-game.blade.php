                ...
                <div class="zone-worker">
                    <div class="zone-one" id="q">
                        <table class="table table-bordered">
                            <tbody>
                            <tr>
                                <td><input type="checkbox" name="ticket1_fieldOne1" id="ticketOne_fieldOne1" value="01"><label for="ticketOne_fieldOne1">1</label></td>
                                <td><input type="checkbox" name="ticket1_fieldOne2" id="ticketOne_fieldOne2" value="02"><label for="ticketOne_fieldOne2">2</label></td>
                                <td><input type="checkbox" name="ticket1_fieldOne3" id="ticketOne_fieldOne3" value="03"><label for="ticketOne_fieldOne3">3</label></td>
                                <td><input type="checkbox" name="ticket1_fieldOne4" id="ticketOne_fieldOne4" value="04"><label for="ticketOne_fieldOne4">4</label></td>
                            </tr>
                            <tr>
                                <td><input type="checkbox" name="ticket1_fieldOne5" id="ticketOne_fieldOne5" value="05"><label for="ticketOne_fieldOne5">5</label></td>
                                <td><input type="checkbox" name="ticket1_fieldOne6" id="ticketOne_fieldOne6" value="06"><label for="ticketOne_fieldOne6">6</label></td>
                                <td><input type="checkbox" name="ticket1_fieldOne7" id="ticketOne_fieldOne7" value="07"><label for="ticketOne_fieldOne7">7</label></td>
                                <td><input type="checkbox" name="ticket1_fieldOne8" id="ticketOne_fieldOne8" value="08"><label for="ticketOne_fieldOne8">8</label></td>
                            </tr>
                            <tr>
                                <td><input type="checkbox" name="ticket1_fieldOne9" id="ticketOne_fieldOne9" value="09"><label for="ticketOne_fieldOne9">9</label></td>
                    ...
                    <div class="zone-two">
                        <table class="table table-bordered">
                            <tbody>
                            <tr>
                                <td><input type="checkbox" name="ticket1_fieldTwo1" id="ticketOne_fieldTwo1" value="01"><label for="ticketOne_fieldTwo1">1</label></td>
                                <td><input type="checkbox" name="ticket1_fieldTwo2" id="ticketOne_fieldTwo2" value="02"><label for="ticketOne_fieldTwo2">2</label></td>
                                <td><input type="checkbox" name="ticket1_fieldTwo3" id="ticketOne_fieldTwo3" value="03"><label for="ticketOne_fieldTwo3">3</label></td>
                                <td><input type="checkbox" name="ticket1_fieldTwo4" id="ticketOne_fieldTwo4" value="04"><label for="ticketOne_fieldTwo4">4</label></td>
                            </tr>
                            <tr>
                                <td><input type="checkbox" name="ticket1_fieldTwo5" id="ticketOne_fieldTwo5" value="05"><label for="ticketOne_fieldTwo5">5</label></td>
                                <td><input type="checkbox" name="ticket1_fieldTwo6" id="ticketOne_fieldTwo6" value="06"><label for="ticketOne_fieldTwo6">6</label></td>
                                <td><input type="checkbox" name="ticket1_fieldTwo7" id="ticketOne_fieldTwo7" value="07"><label for="ticketOne_fieldTwo7">7</label></td>
                                <td><input type="checkbox" name="ticket1_fieldTwo8" id="ticketOne_fieldTwo8" value="08"><label for="ticketOne_fieldTwo8">8</label></td>
                            </tr>
                            <tr>
                                <td><label for="ticketOne_fieldTwo9">9</label><input type="checkbox" name="ticket1_fieldTwo9" id="ticketOne_fieldTwo9" value="09"></td>
