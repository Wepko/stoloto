                                ...
                                <div class="prize-pool">
                                    <div class="prize-pool__title">Призовой фонд игры</div>
                                        <div class="prize-pool__list">
                                            <div class="prize-pool__item">3</div>
                                            <div class="prize-pool__item">2</div>
                                            <div class="prize-pool__item">7</div>
                                            <div class="prize-pool__item">6</div>
                                            <div class="prize-pool__item">0</div>
                                        </div>
                                    </div>
  
                                    <div class="panel-score">
                                        <p class="panel-score__discription">Стоимость одного билета 100р</p>
                                        <div class="panel-score__quantity" style="display: flex; justify-content: space-between>
                                            <span class="panel-score__text">Множитель<select name="factor" id="factor">
                                        ...
                                        <div class="panel-score__btns">
                                            ...
                                            <a href="{{ route('tutorials-five-game')}}" class="btn-orange-revers mt-3" style="width: 100%">Как играть?</a>
                                        </div>
                                    </div>
                            </div>
                        </div>
