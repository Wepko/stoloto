...
<section class="section-game" id="main" >
    ...
    <form action="{{ route('AddTicketValueThree') }}" method='post'>
    @csrf
                            ...
                            <div class="col-lg-4 col-sm-12 order-lg-2 order-sm-1">
                                <div class="prize-pool">
                                    ...
                                    <div class="panel-score">
                                        <p class="panel-score__discription">Стоимость одного билета 25р</p>
                                        ...
                                        <div class="panel-score__btns">
                                            ...
                                            <a href="{{ route('tutorials-three-game')}}" class="btn-orange-revers mt-3" style="width: 100%">Как играть?</a>
                                        </div>
                                    </div>
                            </div>
                        </div>
