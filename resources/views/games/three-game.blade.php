                    ...
                    <div class="zone-one">
                      <div class="zone-header">Поле 1 <p></p></div>
                        <table class="table table-bordered">
                            <tbody>
                            <tr>
                                <td><label for="ticketOne_fieldOne1">1</label><input type="checkbox" name="ticket1_fieldOne1" id="ticketOne_fieldOne1" value="01"></td>
                                <td><label for="ticketOne_fieldOne2">2</label><input type="checkbox" name="ticket1_fieldOne2" id="ticketOne_fieldOne2" value="02"></td>
                                <td><label for="ticketOne_fieldOne3">3</label><input type="checkbox" name="ticket1_fieldOne3" id="ticketOne_fieldOne3" value="03"></td>
                                <td><label for="ticketOne_fieldOne4">4</label><input type="checkbox" name="ticket1_fieldOne4" id="ticketOne_fieldOne4" value="04"></td>
                                <td><label for="ticketOne_fieldOne5">5</label><input type="checkbox" name="ticket1_fieldOne5" id="ticketOne_fieldOne5" value="05"></td>
                                <td><label for="ticketOne_fieldOne6">6</label><input type="checkbox" name="ticket1_fieldOne6" id="ticketOne_fieldOne6" value="06"></td>
                                <td><label for="ticketOne_fieldOne7">7</label><input type="checkbox" name="ticket1_fieldOne7" id="ticketOne_fieldOne7" value="07"></td>
                                <td><label for="ticketOne_fieldOne8">8</label><input type="checkbox" name="ticket1_fieldOne8" id="ticketOne_fieldOne8" value="08"></td>
                                <td><label for="ticketOne_fieldOne9">9</label><input type="checkbox" name="ticket1_fieldOne9" id="ticketOne_fieldOne9" value="09"></td>
                              ...
                              <tr>
                                ...
                                <td><label for="ticketOne_fieldOne33">33</label><input type="checkbox" name="ticket1_fieldTwo33" id="ticketOne_fieldOne33" value="33"></td>
                                <td><label for="ticketOne_fieldOne34">34</label><input type="checkbox" name="ticket1_fieldTwo34" id="ticketOne_fieldOne34" value="34"></td>
                                <td><label for="ticketOne_fieldOne35">35</label><input type="checkbox" name="ticket1_fieldTwo35" id="ticketOne_fieldOne35" value="35"></td>
                                <td><label for="ticketOne_fieldOne36">36</label><input type="checkbox" name="ticket1_fieldTwo36" id="ticketOne_fieldOne36" value="36"></td>
                                <td><label for="ticketOne_fieldOne37">37</label><input type="checkbox" name="ticket1_fieldTwo37" id="ticketOne_fieldOne37" value="37"></td>
                                <td><label for="ticketOne_fieldOne38">38</label><input type="checkbox" name="ticket1_fieldTwo38" id="ticketOne_fieldOne38" value="38"></td>
                                <td><label for="ticketOne_fieldOne39">39</label><input type="checkbox" name="ticket1_fieldTwo39" id="ticketOne_fieldOne39" value="39"></td>
                                <td><label for="ticketOne_fieldOne40">40</label><input type="checkbox" name="ticket1_fieldTwo40" id="ticketOne_fieldOne40" value="40"></td>
                              </tr>
                              <tr>
                                <td><label for="ticketOne_fieldOne31">41</label><input type="checkbox" name="ticket1_fieldTwo31" id="ticketOne_fieldOne31" value="31"></td>
                                <td><label for="ticketOne_fieldOne32">42</label><input type="checkbox" name="ticket1_fieldTwo32" id="ticketOne_fieldOne32" value="32"></td>
                                <td><label for="ticketOne_fieldOne33">43</label><input type="checkbox" name="ticket1_fieldTwo33" id="ticketOne_fieldOne33" value="33"></td>
                                <td><label for="ticketOne_fieldOne34">44</label><input type="checkbox" name="ticket1_fieldTwo34" id="ticketOne_fieldOne34" value="34"></td>
                                <td><label for="ticketOne_fieldOne35">45</label><input type="checkbox" name="ticket1_fieldTwo35" id="ticketOne_fieldOne35" value="35"></td>
                                <td><label for="ticketOne_fieldOne36">46</label><input type="checkbox" name="ticket1_fieldTwo36" id="ticketOne_fieldOne36" value="36"></td>
                                <td><label for="ticketOne_fieldOne37">47</label><input type="checkbox" name="ticket1_fieldTwo37" id="ticketOne_fieldOne37" value="37"></td>
                                <td><label for="ticketOne_fieldOne38">48</label><input type="checkbox" name="ticket1_fieldTwo38" id="ticketOne_fieldOne38" value="38"></td>
                                <td><label for="ticketOne_fieldOne39">49</label><input type="checkbox" name="ticket1_fieldTwo39" id="ticketOne_fieldOne39" value="39"></td>
                              </tr>
                            </tbody>
                        </table> 
                    </div>
